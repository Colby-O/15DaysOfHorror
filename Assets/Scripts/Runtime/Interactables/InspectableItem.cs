...
namespace DOH
{
    ...
    public class InspectableItem : MonoBehaviour, IInteractable
    {
        ...
        public string GetHint()
        {
            ...
            return
                $"Click 'E' to {(DOHGameManager.Inspector.IsInspecting() ? "stop" : "")} {((_inspectType == InspectType.Moveable) ? "pickup" : "inspect")}{(DOHGameManager.Inspector.IsInspecting() ? "ing" : "")}";
        }
        ...
        public bool Interact(Interactor interactor)
        {
            ...
            if (DOHGameManager.Inspector) DOHGameManager.Inspector.StartInspect(transform, _inspectType, _rotateWithPlayer, _offset, _targetOverride, _text, _comeToOffsetOverride);
            return true;
        }
        ...
        {
            if (DOHGameManager.Inspector.IsInspecting() && _hasOutline) RemoveOutline();
        }
